        ...
        <Phone>
          ...
          <section className="mt-4">
            ...
            <div className="flex  items-center gap-3  space-y-2 p-3 text-text-primary hover:bg-gray-50">
              <Music size={22} />
              <span className="text-sm font-semibold">Customize notifications</span>
            </div>
            <div className="flex  items-center gap-3  space-y-2 p-3 text-text-primary hover:bg-gray-50">
              <File size={22} />
              <span className="text-sm font-semibold">Viewing multimedia files</span>
            </div>
            ...
            <div className="flex   gap-3  space-y-2 p-3 text-text-primary hover:bg-gray-50">
              ...
              <div className="flex flex-col gap-1">
                <span className="text-sm font-semibold">Temporary messages</span>
